...
public static class ItemDatabase
{
    ...
    public static readonly Consumable Soup = new Consumable(29, TextDatabase.Soup, TextDatabase.SoupDescription, 20, Resources.Load<Texture2D>("Sprites/Items/Foods/Soup"), new Entity(EntityDatabase.Soup), new Effect(Effect.EffectType.Saturation, 10), Resources.Load<GameObject>("Prefabs/Consumables/Foods/Soup"));
