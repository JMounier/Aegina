...
public static class ItemDatabase
{
    ...
    public static readonly Consumable GreenPotion = new Consumable(21, TextDatabase.GreenPotion, TextDatabase.GreenPotionDescription, 64, Resources.Load<Texture2D>("Sprites/Items/Potions/GreenPotion"), new Entity(EntityDatabase.GreenPotion), new Effect(Effect.EffectType.Poison, 2));
    public static readonly Consumable PurplePotion = new Consumable(22, TextDatabase.PurplePotion, TextDatabase.PurplePotionDescription, 64, Resources.Load<Texture2D>("Sprites/Items/Potions/PurplePotion"), new Entity(EntityDatabase.PurplePotion), new Effect(Effect.EffectType.Speed, 1));
    public static readonly Consumable RedPotion = new Consumable(23, TextDatabase.RedPotion, TextDatabase.RedPotionDescription, 64, Resources.Load<Texture2D>("Sprites/Items/Potions/RedPotion"), new Entity(EntityDatabase.RedPotion), new Effect(Effect.EffectType.Regeneration, 1));
    public static readonly Consumable YellowPotion = new Consumable(24, TextDatabase.YellowPotion, TextDatabase.YellowPotionDescription, 64, Resources.Load<Texture2D>("Sprites/Items/Potions/YellowPotion"), new Entity(EntityDatabase.YellowPotion), new Effect(Effect.EffectType.JumpBoost, 1));
    ...
    public static readonly Pickaxe IronPickaxe = new Pickaxe(52, TextDatabase.IronPickaxe, TextDatabase.IronPickaxeDescription, 250, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/IronPickaxe"), new Entity(EntityDatabase.IronPickaxe), null);
    public static readonly Pickaxe GoldPickaxe = new Pickaxe(53, TextDatabase.GoldPickaxe, TextDatabase.GoldPickaxeDescription, 50, 150, Resources.Load<Texture2D>("Sprites/Items/Tools/GoldPickaxe"), new Entity(EntityDatabase.GoldPickaxe), null);
    public static readonly Pickaxe MithrilPickaxe = new Pickaxe(54, TextDatabase.MithrilPickaxe, TextDatabase.MithrilPickaxeDescription, 200, 200, Resources.Load<Texture2D>("Sprites/Items/Tools/MithrilPickaxe"), new Entity(EntityDatabase.MithrilPickaxe), null);
    public static readonly Pickaxe FloatiumPickaxe = new Pickaxe(55, TextDatabase.FloatiumPickaxe, TextDatabase.FloatiumPickaxeDescription, 200, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/FloatiumPickaxe"), new Entity(EntityDatabase.FloatiumPickaxe), null);
    public static readonly Pickaxe SunkiumPickaxe = new Pickaxe(56, TextDatabase.SunkiumPickaxe, TextDatabase.SunkiumPickaxeDescription, 500, 300, Resources.Load<Texture2D>("Sprites/Items/Tools/SunkiumPickaxe"), new Entity(EntityDatabase.SunkiumPickaxe), null);

    public static readonly Axe StoneAxe = new Axe(60, TextDatabase.StoneAxe, TextDatabase.StoneAxeDescription, 100, 100, Resources.Load<Texture2D>("Sprites/Items/Tools/StoneAxe"), new Entity(EntityDatabase.StoneAxe), null);
    public static readonly Axe CopperAxe = new Axe(61, TextDatabase.CopperAxe, TextDatabase.CopperAxeDescription, 150, 150, Resources.Load<Texture2D>("Sprites/Items/Tools/CopperAxe"), new Entity(EntityDatabase.CopperAxe), null);
    public static readonly Axe IronAxe = new Axe(62, TextDatabase.IronAxe, TextDatabase.IronAxeDescription, 250, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/IronAxe"), new Entity(EntityDatabase.IronAxe), null);
    public static readonly Axe GoldAxe = new Axe(63, TextDatabase.GoldAxe, TextDatabase.GoldAxeDescription, 50, 150, Resources.Load<Texture2D>("Sprites/Items/Tools/GoldAxe"), new Entity(EntityDatabase.GoldAxe), null);
    public static readonly Axe MithrilAxe = new Axe(64, TextDatabase.MithrilAxe, TextDatabase.MithrilAxeDescription, 200, 200, Resources.Load<Texture2D>("Sprites/Items/Tools/MithrilAxe"), new Entity(EntityDatabase.MithrilAxe), null);
    public static readonly Axe FloatiumAxe = new Axe(65, TextDatabase.FloatiumAxe, TextDatabase.FloatiumAxeDescription, 200, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/FloatiumAxe"), new Entity(EntityDatabase.FloatiumAxe), null);
    public static readonly Axe SunkiumAxe = new Axe(66, TextDatabase.SunkiumAxe, TextDatabase.SunkiumAxeDescription, 500, 300, Resources.Load<Texture2D>("Sprites/Items/Tools/SunkiumAxe"), new Entity(EntityDatabase.SunkiumAxe), null);

    public static readonly Sword StoneSword = new Sword(70, TextDatabase.StoneSword, TextDatabase.StoneSwordDescription, 100, 140, Resources.Load<Texture2D>("Sprites/Items/Tools/StoneSword"), new Entity(EntityDatabase.StoneSword), null);
    public static readonly Sword CopperSword = new Sword(71, TextDatabase.CopperSword, TextDatabase.CopperSwordDescription, 150, 180, Resources.Load<Texture2D>("Sprites/Items/Tools/CopperSword"), new Entity(EntityDatabase.CopperSword), null);
    public static readonly Sword IronSword = new Sword(72, TextDatabase.IronSword, TextDatabase.IronSwordDescription, 250, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/IronSword"), new Entity(EntityDatabase.IronSword), null);
    public static readonly Sword GoldSword = new Sword(73, TextDatabase.GoldSword, TextDatabase.GoldSwordDescription,50, 180, Resources.Load<Texture2D>("Sprites/Items/Tools/GoldSword"), new Entity(EntityDatabase.GoldSword), null);
    public static readonly Sword MithrilSword = new Sword(74, TextDatabase.MithrilSword, TextDatabase.MithrilSwordDescription, 200, 200, Resources.Load<Texture2D>("Sprites/Items/Tools/MithrilSword"), new Entity(EntityDatabase.MithrilSword), null);
    public static readonly Sword FloatiumSword = new Sword(75, TextDatabase.FloatiumSword, TextDatabase.FloatiumSwordDescription, 200, 250, Resources.Load<Texture2D>("Sprites/Items/Tools/FloatiumSword"), new Entity(EntityDatabase.FloatiumSword), null);
    public static readonly Sword SunkiumSword = new Sword(76, TextDatabase.SunkiumSword, TextDatabase.SunkiumSwordDescription, 500, 300, Resources.Load<Texture2D>("Sprites/Items/Tools/SunkiumSword"), new Entity(EntityDatabase.SunkiumSword), null);
