...
public static class EntityDatabase
{
    ...
    public static readonly Mob Pampa = new Mob(502, 15, Resources.Load<GameObject>("Prefabs/Mobs/Pampa"), 21, .7f, 8, 1.5f, 8f, 1f, 3.8f, 1.8f, 1f,
    ...
    public static readonly Mob SnowBunny = new Mob(504, 10, Resources.Load<GameObject>("Prefabs/Mobs/SnowBunny"), 9, .25f, 0, 0f, 6f, 1.5f, 3f, 1f, 0f,
        new int[1] { 2 }, new DropConfig(83, 1), new DropConfig(86, 0, 1), new DropConfig(88, 1), new DropConfig(85, 0, 1));
    public static readonly Mob Bunny = new Mob(505, 10, Resources.Load<GameObject>("Prefabs/Mobs/Bunny"), 12, .25f, 0, 0f, 6f, 1.5f, 3f, 1f, 0f,
        new int[2] { 0, 3 }, new DropConfig(83, 1), new DropConfig(86, 0, 1), new DropConfig(88, 1), new DropConfig(85, 0, 1));
    public static readonly Mob Penguin = new Mob(506, 10, Resources.Load<GameObject>("Prefabs/Mobs/Penguin"), 18, 1f, 0, 6f, 0f, 0.8f, 1.5f, 1f, 2f,
      new int[1] { 2 }, new DropConfig(83, 1), new DropConfig(86, 0, 1), new DropConfig(88, 1));
    public static readonly Mob SlimeAqua = new Mob(507, 35, Resources.Load<GameObject>("Prefabs/Mobs/SlimeAqua"), 6, .3f, 4, 5f, 0f, 0.6f, 1.2f, 1.25f, 1f,
      new int[3] { 0, 1, 3 });
    ...
    public static readonly Mob SlimeGreen = new Mob(509, 35, Resources.Load<GameObject>("Prefabs/Mobs/SlimeGreen"), 6, .3f, 4, 5f, 0f, 0.6f, 1.2f, 1.25f, 1f,
     new int[3] { 0, 1, 3 });
    public static readonly Mob SlimeGreenSmall = new Mob(510, 15, Resources.Load<GameObject>("Prefabs/Mobs/SlimeGreenSmall"), 0, .3f, 2, 3f, 0f, 0.8f, 1.5f, 1.5f, .75f,
      new int[0] { }, new DropConfig(31, 1), new DropConfig(31, 0, 1), new DropConfig(31, 0, 1));
    public static readonly Mob SlimeYellow = new Mob(511, 35, Resources.Load<GameObject>("Prefabs/Mobs/SlimeYellow"), 6, .3f, 4, 5f, 0f, 0.6f, 1.2f, 1.25f, 1f,
     new int[3] { 0, 1, 3 });
    public static readonly Mob SlimeYellowSmall = new Mob(512, 15, Resources.Load<GameObject>("Prefabs/Mobs/SlimeYellowSmall"), 0, .3f, 2, 3f, 0f, 0.8f, 1.5f, 1.5f, .75f,
      new int[0] { }, new DropConfig(31, 1), new DropConfig(31, 0, 1), new DropConfig(31, 0, 1));
    public static readonly Mob SlimeChief = new Mob(512, 75, Resources.Load<GameObject>("Prefabs/Mobs/SlimeChief"), 1, .5f, 25, 8f, 0f, 0.8f, 1.5f, 1.5f, 1f,
    ...
    public static IEnumerable<Element> Elements
    {
        get
        {
            ...
            yield return CristalProjectileRed;
            yield return CristalProjectileGreen;
            yield return CristalProjectileYellow;
        }
    }
