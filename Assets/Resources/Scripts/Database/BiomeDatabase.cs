...
public static class BiomeDatabase
{
    ...
    // To do...
    public static readonly Biome Forest = new Biome(0, new SpawnConfig(new Entity(), 1), new SpawnConfig(EntityDatabase.Fir, 1), new SpawnConfig(EntityDatabase.SnowFir, 3));
