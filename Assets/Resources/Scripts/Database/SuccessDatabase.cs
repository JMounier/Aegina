...
public class SuccessDatabase
{
    ...
    public static readonly Success GoldAge = new Success(40, 20, 0, TextDatabase.StoneAge, ItemDatabase.GoldIngot, new Requirement.Requirements[0] { }, 1,OtherLVL3,DivineLVL4);
    ...
    public static readonly Success CopperAge = new Success(20, 10, 0, TextDatabase.StoneAge, ItemDatabase.CopperIngot, new Requirement.Requirements[0] { }, 1, FirstHeal, Cauldron, DivineLVL3, Forge);
