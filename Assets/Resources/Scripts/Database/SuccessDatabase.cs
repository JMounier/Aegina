...
{
    public static readonly Success FirstEnd = new Success(73, 40, 1, TextDatabase.FirstEnd, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.FirstEnd }, 1);
    public static readonly Success SecondEnd = new Success(72, 40, -1, TextDatabase.SecondEnd, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.SecondEnd }, 1);
    public static readonly Success GunDam = new Success(71, 38, 0, TextDatabase.KillTheBoss, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.KillTheBoss }, 1,FirstEnd,SecondEnd);
    ...
    public static readonly Success DivineLVL5 = new Success(63, 34, 0, TextDatabase.DivineCrisatlLVL5, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.DivineCrisatlLVL5 }, 2,SunkiumAge);
    public static readonly Success OtherLVL5 = new Success(62, 32, 1, TextDatabase.OtherCristalLVL5, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.OtherCristalLVL5 }, 1,DivineLVL5);
    ...
    public static readonly Success Pampichief = new Success(34, 18, 0, TextDatabase.HuntPampiChief, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.HuntPampiChief }, 3,GoldAge);
    ...
    public static readonly Success EquipIron = new Success(32, 16, 0, TextDatabase.EquipInIron, ItemDatabase.IronSword, new Requirement.Requirements[1] { Requirement.Requirements.EquipInIron }, 1, Pampichief);
    ...
    public static readonly Success BoarChief = new Success(15, 8, 0, TextDatabase.HuntBoarChief, ItemDatabase.Apple, new Requirement.Requirements[1] { Requirement.Requirements.HuntBoarChief }, 4, CopperAge);
