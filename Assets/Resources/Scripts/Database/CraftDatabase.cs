...
public static class CraftDatabase
{
    ...
    public static readonly Craft MithrilPickaxe = new Craft(31, new ItemStack(ItemDatabase.MithrilPickaxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.MithrilIngot, 2), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft FloatiumPickaxe = new Craft(32, new ItemStack(ItemDatabase.FloatiumPickaxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.FloatiumIngot, 2), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft SunkiumPickaxe = new Craft(33, new ItemStack(ItemDatabase.SunkiumPickaxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.SunkiumIngot, 2), new ItemStack(ItemDatabase.Stick, 1));

	public static readonly Craft StoneAxe = new Craft(34, new ItemStack(ItemDatabase.StoneAxe, 1), false, false, false, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.Stone, 2), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft CopperAxe = new Craft(35, new ItemStack(ItemDatabase.CopperAxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.CopperIngot, 1), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft IronAxe = new Craft(36, new ItemStack(ItemDatabase.IronAxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.IronIngot, 1), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft GoldAxe = new Craft(37, new ItemStack(ItemDatabase.GoldAxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.GoldIngot, 1), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft MithrilAxe = new Craft(38, new ItemStack(ItemDatabase.MithrilAxe, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.MithrilIngot, 1), new ItemStack(ItemDatabase.Stick, 1));
    ...
    public static readonly Craft MithrilSword = new Craft(45, new ItemStack(ItemDatabase.MithrilSword, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.MithrilIngot, 3), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft FloatiumSword = new Craft(46, new ItemStack(ItemDatabase.FloatiumSword, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.FloatiumIngot, 3), new ItemStack(ItemDatabase.Stick, 1));
    public static readonly Craft SunkiumSword = new Craft(47, new ItemStack(ItemDatabase.SunkiumSword, 1), false, true, true, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.SunkiumIngot, 3), new ItemStack(ItemDatabase.Stick, 1));
