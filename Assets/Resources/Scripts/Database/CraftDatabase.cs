...
{
    public static readonly Craft Torch = new Craft(0, new ItemStack(ItemDatabase.Torch, 1), true, false, false, false, false, Craft.Type.WorkTop, new ItemStack(ItemDatabase.Stick, 1), new ItemStack(ItemDatabase.AnimalFat,1));
	public static readonly Craft FireCamp = new Craft(1,new ItemStack(ItemDatabase.Firepit,1),false,false,false,false,false,Craft.Type.WorkTop,new ItemStack(ItemDatabase.Log,3),new ItemStack(ItemDatabase.Stone,3),new ItemStack(ItemDatabase.AnimalFat,2));
	...
	public static readonly Craft Stew = new Craft(21,new ItemStack(ItemDatabase.Soup,1),false,false,false,true,false,Craft.Type.Consumable,new ItemStack(ItemDatabase.Bowl,1),new ItemStack(ItemDatabase.Gigot,2),new ItemStack(ItemDatabase.WaterCact,1),new ItemStack(ItemDatabase.Pumpkin,1));
    ...
    public static readonly Craft Potion6 = new Craft(27, new ItemStack(ItemDatabase.JumpPotion, 1), false, false, false, true, false, Craft.Type.Consumable, new ItemStack(ItemDatabase.Glass, 1), new ItemStack(ItemDatabase.Pumpkin, 2), new ItemStack(ItemDatabase.WaterCact, 1));
