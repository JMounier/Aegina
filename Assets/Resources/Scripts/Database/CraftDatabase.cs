...
public static class CraftDatabase
{
	...
	public static readonly Craft StoneAxe = new Craft(34, new ItemStack(ItemDatabase.StoneAxe, 1), false, false, false, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.Stone, 5), new ItemStack(ItemDatabase.Stick, 2));
    ...
    public static readonly Craft StoneSword = new Craft(41, new ItemStack(ItemDatabase.StoneSword, 1), false, true, false, false, false, Craft.Type.Tools, new ItemStack(ItemDatabase.Stone, 8), new ItemStack(ItemDatabase.Stick, 1));
