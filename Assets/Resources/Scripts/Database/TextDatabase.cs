...
public class TextDatabase
{
	...
	public static readonly Text CinematiqueWhereIAm1 = new Text ("Maintenant que Ille a trouvé de quoi survivre, il peut enfin se reposer. Jusqu'à présent  Ille n'a pensé qu'à manger mais une fois le ventre rempli il se met à penser et à se questionner \" Mais où suis-je? Quel est cet endroit ?\" En effet cet archipel d'îles volantes ne lui est pas familier ", "Now that Ille has found how to survive he can finally rest. So far Ille only thougt to eat but once his stomach fill he begin to think and to question himself \" where am I? What is this place? \" Indeed this archipelago of floating island was not a familiar landscape for Ille.");
	public static readonly Text CinematiqueWhereIAm2 = new Text ("\"Attends !!! Des îles volantes ?? Mais ce n'est pas possible, ça ne peut pas exister \" Et pourtant ce qui s'étend à perte de vue n'est pas une illusion. Ille ne se trouve plus chez lui, peut être même plus dans son monde.", "\"Wait !!! Floating islands ?? But this is not possible, it can't exist \"Yet what lies out of sight is not an illusion. Ille is no longer at home, perhaps even not in his world.");
    ...
    public static readonly Text BlackEyes = new Text("Yeux marron", "Brown Eyes");
    public static readonly Text GreenEyes = new Text("Yeux vert", "Vert Eyes");
