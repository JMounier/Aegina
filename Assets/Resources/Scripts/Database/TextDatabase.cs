...
public class TextDatabase
{
    ...
    public static readonly Text FinSacrifice = new Text("Plutôt que d'utiliser le pouvoir du cristal pour rentrer chez lui Ille le détruisi. Il ne voyait plus l'intêret de rentrer chez lui après tout ce qu'il avait fait. Le pouvoir du cristal était si grand qu'il aurait surement impacter tout aegina si il avait tenter de l'utiliser. Ille repensa à tous ce qu'il avait commis et fut ronger par des remords. Ille attendit dans les abbyses sa fin. Il ne savait pas mais la destruction de Gundam avait engendrer la destruction de tout les cristaux d'Aegina ce qui offrirait enfin la paix à ce monde.", 
